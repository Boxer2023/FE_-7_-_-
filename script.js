...
function findMin(a, b) {
  ...
  const minNumber = findMin(5, 3);
// console.log(minNumber); // Выведет 3

_____________________________________________________________________________________
// Задача 2.
// Напишите функцию, которая выводит в консоль все четные числа 
...
// const result1 = power(2); // Результат будет 2^2 = 4
// const result2 = power(3, 3); // Результат будет 3^3 = 27

// console.log(result1); // Вывод: 4
// console.log(result2); // Вывод: 27
...
// _____________________________________________________________________________________
// Задача 6.
// Напишите функцию, которая принимает в качестве аргументов массив строк, а возвращает первый 
